...
export const Sidebar: React.FC = () => {
  return (
    <aside className="hidden lg:flex flex-col w-72 bg-white border-r border-gray-200 h-screen sticky top-0 shrink-0">
      ...
      <nav className="flex-1 p-4 space-y-2 overflow-y-auto custom-scrollbar">
        ...
        <div
          className="flex items-center w-full gap-3 px-3 py-2.5 rounded-xl bg-green-50 text-green-700 font-semibold ring-1 ring-green-100 shadow-sm"
        >
      ...
      <div className="p-4 bg-gray-50 m-4 rounded-2xl border border-gray-100">
        ...
        <p className="text-[10px] text-gray-500 leading-relaxed">Keep your phone charged and follow local official emergency channels for real-time updates.</p>
      </div>
    </aside>
  );
};
